  ...
  return (
    <div className="p-4 md:p-6 pb-24 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <ResumoCard titulo="Check-ins" valor={checkins.length} icone={<CheckCircle className="w-8 h-8 text-green-400" />} />
        <ResumoCard titulo="Planos" valor={planos.length} icone={<ShieldCheck className="w-8 h-8 text-blue-400" />} />
        <ResumoCard titulo="Pontos" valor={pontos.length} icone={<MapPin className="w-8 h-8 text-cyan-400" />} />
        <ResumoCard titulo="Dentro do raio" valor={dentroRaio} icone={<Route className="w-8 h-8 text-emerald-400" />} />
        <ResumoCard titulo="Fora do raio" valor={foraRaio} icone={<Route className="w-8 h-8 text-red-400" />} />
      </div>
