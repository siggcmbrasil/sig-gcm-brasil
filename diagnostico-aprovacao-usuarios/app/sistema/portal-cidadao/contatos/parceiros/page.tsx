...
export default function ParceirosPage() {
  ...
  async function carregar() {
    ...
    if (error) {
      console.error(error);
      alert("Erro ao carregar instituições parceiras.");
      setCarregando(false);
      return;
    }
  ...
  return (
    <div className="p-4 md:p-6 pb-24 space-y-6">
      <SigPageHeader
        ...
        subtitulo="Conselho Tutelar, Ministério Público, Judiciário e demais instituições parceiras."
        icone={Shield}
      />
      ...
      {carregando ? (
        ...
        <SigEmpty
          ...
          descricao="Cadastre contatos com categoria Instituição Parceira para aparecerem aqui."
        />
      ) : (
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 space-y-1 text-sm">
                    <p className="text-slate-300">
                      Fixo:{" "}
                      {contato.telefone_fixo || "Não informado"}
                    </p>
