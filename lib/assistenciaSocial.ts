...
export type UsuarioAssistenciaSocial = {
  id: string | number;
  nome: string;
  perfil: string;
  municipio_id: number;
...
export function lerUsuarioAssistenciaSocial(): UsuarioAssistenciaSocial | null {
...
export function podeGerenciarAssistenciaSocial(perfil: string) {
  return [
    "DESENVOLVEDOR",
    "ADMIN",
    "COMANDANTE",
