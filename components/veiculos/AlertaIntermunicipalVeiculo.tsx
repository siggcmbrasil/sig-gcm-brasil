...
export type RegistroAlertaIntermunicipal = {
  id: number;
  municipio_id: number;
  municipio: string;
  estado: string;
...
export type AlertaIntermunicipalVeiculoDados = {
  alerta: boolean;
  placa?: string;
  total_registros: number;
  total_municipios: number;
  ultimo_registro:
    | RegistroAlertaIntermunicipal
    | null;
  registros:
    RegistroAlertaIntermunicipal[];
};
...
export default function AlertaIntermunicipalVeiculo({
  alerta,
  carregando = false,
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-300">
              Não foram encontrados registros desta placa em outros municípios da rede.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-4 text-xs text-slate-400">
            O alerta apresenta somente informações operacionais resumidas. Narrativas, documentos pessoais, fotos e dados sensíveis permanecem protegidos no município de origem.
          </p>
